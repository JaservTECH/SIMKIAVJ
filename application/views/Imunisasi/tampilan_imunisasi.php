...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<?php 
			 echo form_open('imunisasi/tambah_data'); //membuka file tambah_data di c_mhs 
			?>
					...
					<div class="col-md-6">
						...
						<div class="row">	
							<div class="form-group">
								...
								<div class="checkbox">
									<div class="col-md-9">
										<?php echo form_dropdown('imunisasi',$list_imunisasi,'', 'class="form-control" ')?>									
									</div>
								</div>
							</div>
						</div>	
