	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<?php 
				 echo form_open('pemeriksaan_anak/tambah_data'); //membuka file tambah_data di c_mhs 
				?>
				...
				<div class="row">
						...
						<div class="row">	
							<div class="form-group">
								...
								<div class="checkbox">
									<div class="col-md-9">
										<div class="input-group">
											<input class="form-control" id="lingkar_kep" placeholder="Lingkar Kepala"
											<?php echo form_input('lingkar_kep'); ?>	
											<span class="input-group-addon">cm</span>
										</div>
									</div>
								</div>
					...
					<div class="col-md-6">
						<div class="row">
							<div class="form-group">
								...
								<div class="checkbox">
									<div class="col-md-8">
										<div class="input-group">
											<input class="form-control" id="napas" placeholder="Frequensi Napas"
						...
						<div class="row">	
							<div class="form-group">
								...
								<div class="checkbox">
									<div class="col-md-8">
										<div class="form-group">
											<div class="input-group">
												<input class="form-control" id="jantung" placeholder="Frequensi Denyut Jantung"
												<?php echo form_input('jantung'); ?>	
												<span class="input-group-addon">/menit</span>
											</div>
										</div>
									</div>
							...
							<div class="checkbox">
								<textarea class="form-control" row="3" <?php echo form_input('diagnosis'); ?></textarea>
							</div>
						
								<label>Tindakan</label>
									<div class="checkbox">
								<textarea class="form-control" row="3" <?php echo form_input('tindakan'); ?></textarea>
							</div>
